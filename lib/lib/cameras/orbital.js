...
var OrbitalCamera = function(elem, renderer, f, props) {
    ...
    this.azimuth = propOrDefault("azimuth", -90);         // the angle of rotation around Y axis
...
OrbitalCamera.prototype.setHint = function(range) {
    ...
    this.zoomF = util.clamp(1, 10, 10 * Math.log(dist - 0.1) / 3);
...
OrbitalCamera.prototype._bindHandlers = function() {
    ...
    var onmousewheel = function(e) {
        e.preventDefault();
        var d = 0.01 * e.wheelDelta * o.zoomF;
        o.distance -= d;

...
QuadTreeNodePolicy.prototype.start = function() {
    ...
    var trigger = new TriggeredDispatch(500, function(view) {
        ...
        if (ratio < 0.1) {
            var bailAtDepth = depthToTraverse(ratio / 0.1);

            console.log("view-params:", viewDist, ratio, bailAtDepth, o.maxDepth);

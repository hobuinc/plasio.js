...
module.exports = {
    ...
    Modes: {
        ...
        PointPicker: require("./modes/point-picker").PointPicker,
        LineOfSightPicker: require("./modes/line-of-sight-picker").LineOfSightPicker
    },

    Features: {
        Profiler: require("./features/profile").Profiler,
        LineOfSight: require("./features/line-of-sight").LineOfSight
    },

...
export class PointCloudViewer extends EventEmitter {
     ...
     * @param [params.pointBudget] {Number} A hint into how many points to load at max.  Defaults to 2 million.
    ...
    constructor(targetElement, params) {
        ...
        this.pointBudget = util.checkParam(params, 'pointBudget', 2000000);
    ...
    async start() {
        ...
        const stopSplitDepth = this.numPoints ? Math.ceil((Math.log(this.numPoints) / Math.log(4)) * 1.4) : 16;
        ...
        console.log("... point budget:", this.pointBudget);

...
export class PointCloudViewer extends EventEmitter {
    ...
    async _readResourceConfig(r) {
        ...
        const url = (eptRootUrl != null) ? (eptRootUrl + (eptRootUrl.endsWith("/") ? "" : "/") + "entwine.json") :
    ...
    async start() {
        ...
        allConfigs.forEach(config => {
            ...
            console.log("... EPT hierarchy step:", config.hierarchyStep);
            ...
            const pipelineLoader = new GreyhoundPipelineLoader({
                ...
                state.schema, {
                    ...
                    eptHierarchyStep: config.hierarchyStep
                });

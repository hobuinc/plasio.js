...
var generateBuffer = function(depthStart, depthEnd, bbox) {
	...
	console.log("gen buffer:", x1, y1, x2, y2);
...
GreyhoundPipelineLoader.load = function(params, cb) {
	...
	// we are going to be talking to the greyhound server here, we need to flip back our space to
	// point cloud space where z goes up, and x is flipped
    var bbox = [params.mins[0], params.mins[2], params.mins[1], params.maxs[0], params.maxs[2], params.maxs[1]];

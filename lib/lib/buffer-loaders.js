...
var load = function(params, cb) {
	...
	var qs = "schema=" + encodeURIComponent(JSON.stringify(schema)) + "&" +
	...
	if (false) {
		...
		util.getBinary(u, depthBegin, depthEnd, function(err, buffers) {
			/*
...
GreyhoundPipelineLoader.load = function(params, cb) {
	console.log(params.depthBegin, params.depthEnd);

...
LinePicker.prototype._attachHandlers = function() {
    ...
    var pick = function(e) {
        ...
        // also add a label to show users the length of this segment
        var center = vec3.lerp([0, 0, 0], o.lastPickedPoint, p, 0.5);
        var distance = vec3.distance(o.lastPickedPoint, p);
        o.renderer.addLabel(id, center, distance.toFixed(3));
    };
    ...
    var mouseover = function(e) {
        ...
        if (o.currentLineId) {
            ...
            var center = vec3.lerp([0, 0, 0], o.lastPickedPoint, p, 0.5);
            var distance = vec3.distance(o.lastPickedPoint, p);
            o.renderer.updateLabel(o.currentLineId, center, distance.toFixed(3));
    ...
    this._detachHandlers = function() {
        ...
        if (o.currentLineId) {
            o.renderer.removeLineSegment(o.currentLineId);
            o.renderer.removeLabel(o.currentLineId);
        }

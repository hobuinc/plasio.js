...
class Preloader {
    constructor(loader, center, normalize) {
        this.loader = loader;
        this.nodesToLoad = [];
        this.center = center;
        this.aborted = false;
    ...
    walkTree(baseNode, cb, done) {
        ...
        let q = async.queue((node, done1) => {
            ...
            let queryParams = {
                pointCloudBBox: bbox,
                fullPointCloudBBox: fullPointBBox,
                worldBBox: worldBBox,
            ...
            let params = o.loader.queryFor(queryParams);
...
FrustumLODNodePolicy.prototype.start = function() {
    ...
    var trigger = new TriggeredDispatch(500, function(view) {
        ...
        let loader = new Preloader(o.pointLoader, center, o.normalize);
        lastLoader = loader;

...
Box.prototype.subdivide = function(zeroReturn) {
    ...
    console.log("Area is:", area, "/", areaLimit, " at depth ", this.depth, "split:", splitChildren);
...
FrustumLODNodePolicy.prototype.start = function() {
    ...
    var trigger = new TriggeredDispatch(500, function(view) {
        ...
        var baseDepth = 6; // this is always a good base depth
	    ...
	    console.log("frustum perspective:", 60, aspect, near, far);
	    ...
	    // to touch it.
        //
        // I changed my mind, I touched it all
        ...
        //
        debug.clear();
        debug.drawLineOfSight(eye, target);

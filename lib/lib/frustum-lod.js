...
FrustumLODNodePolicy.prototype.start = function() {
    ...
    var trigger = new TriggeredDispatch(500, function(view) {
        ...
        */
        ...
        o.renderer.addRemovePointBuffers(_.map(newNodes, makeId), _.map(nodesToRemove, makeId));

        /*
        o.renderer.addPointBufferBatch(_.map(newNodes, makeId));
        o.renderer.removePointBufferBatch(_.map(nodesToRemove, makeId));
         */
        ...
        o.clearAll = function() {
            o.renderer.removePointBufferBatch(_.map(o.nodes, makeId));
        };
    });
